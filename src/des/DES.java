...
public class DES {
	...
	final static int sbox[][] = {
			 ...
			 { 9, 2, 8, 4, 6, 15, 11, 1, 10, 9, 3, 14, 5, 0, 12, 7,
	...
	public static int[] fiesteld()
	{
		
		int plain[] = {0,32,1,0};
		int plain1[] = {0,32,1,0,0,0};
		...
		for(int j=0;j<6;j++)
		{
			...
			{				
			 ...
			 tempPlain1[j] = x;
			 System.out.println(tempPlain1[j]);
		}
	...
	public static void main(String[] args) 
	{
		...
		for(int i=0;i<4;i++)
		{
			System.out.print(hex[p[i]/16]+""+hex[p[i]%16]);
		}
	}
